...
<html lang="en">
  <head>
    ...
    <style>  
        ...
        .move-right > span {
            display: inline-block;
            transform: translateX(100px); /* ขยับข้อความไปทางขวา 10px */
            font-size: 20px;
        }
        </style>
</head>
...
<div style="text-align: center;">
     <h1 class="text-dark " id="h4">คณะผู้จัดทำ</h1>
     <br>
     <img src="name1.jpg" style="height: 0%;" width="15%" >
     <h2 class="text-dark " id="h4">นาย ธนพล ไกรการ</h2>
        <br>
     <h5 class="text-dark " id="h4">เลขที่23 ปวช 3/2</h5>
        <br>
     <img src="name.jfif" style="height: 0%;" width="15%" >
     <h2 class="text-dark " id="h4">นาย ศรีวิสุทธิ์ จิตรมั่น</h2>
        <br>
     <h5 class="text-dark " id="h4">เลขที่19 ปวช 3/2</h5>   
     <br>
     <img src="name2.jpg" style="height: 0%;" width="15%" >
     <h2 class="text-dark " id="h4">นาย อนุวัฒน์ องค์อาจ</h2>
        <br>
     <h5 class="text-dark " id="h4">เลขที่26 ปวช 3/2</h5>  
