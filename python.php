...
<div style="text-align: center;">
    <img src="มารู้จักกับpython.png" style="height: 0%;" width="30%" >
     <h4 class="text-dark " id="h4">บทที่1</h4>
</div>
<nav class="navbar " >
<form class="container-fluid nav justify-content-center ">
  ...
  <form class="container-fluid nav justify-content-center ">
    <a id="button3" href="content.php" class="btn btn-outline-success " type="button">เนื้อหา</a><nav class="navbar ">
  <form  class="container-fluid nav justify-content-center ">
