...
<div style="text-align: center;">
    <img src="lf.png" style="height: 0%;" width="30%" >
     <h4 class="text-dark " id="h4">บทที่3</h4>
     <br>
     <h4 class="text-dark " id="h4">-IF else elif ใช้ยังไง-</h4>
</div>
<nav class="navbar " >
<form class="container-fluid nav justify-content-center ">
    <a href="https://forms.gle/V2p5jqAChDsPG2Xa6" target="_blank" id="button3" class="btn btn-outline-success " type="button" href="db.php" >แบบทดสอบก่อนเรียน</a><nav class="navbar ">
  <form class="container-fluid nav justify-content-center ">
    <a id="button3" href="lf1.php" class="btn btn-outline-success " type="button">เนื้อหา</a><nav class="navbar ">
  <form  class="container-fluid nav justify-content-center ">
  <a  href="https://youtube.com/@DS_MH?si=J0hOfsbZ0DYsKR3E" target="_blank" id="button3" class="btn btn-outline-success " type="button">Youtube</a><nav class="navbar ">
  <form  class="container-fluid nav justify-content-center ">
    <a href="https://forms.gle/aDp2iiXBxDkpizCk6" target="_blank" id="button3" class="btn btn-outline-success " type="button">แบบทดสอบหลังเรียน</a>
  </form>
</nav>
  </form>
</nav>
