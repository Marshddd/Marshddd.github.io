...
<div style="text-align: center;">
     <h1 class="text-dark " id="h4">ครูที่ปรึกษา</h1>
     <br>
     <img src="paisan.jpg" style="height: 0%;" width="15%" >
     <h2 class="text-dark " id="h4">นายไพศาล พู่เจริญ</h2>
        <br>
     <h5 class="text-dark " id="h4">พนักงานราชการ (ครู)
