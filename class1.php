...
<div style="text-align: center;"> <img src="บทที่2.jpg" style="height: 100%;" width="50%" ></div>
<br><br>
...
<iframe width="800" height="500" src="https://www.youtube.com/embed/-CyFddlnn4U?si=RRUKCkL3iOJmUg97" frameborder="0" allowfullscreen></iframe> 
</div>
...
<div style="text-align: rigth;" >
        ...
        <br>
    <h4 class="text-dark "  >1.Classes & Objects</h4>
    <br><br>
    <h1 class="text-dark  " style="font-weight: bold;" >-Code ในคลิป-</h1>
    <br>
    <button onclick="copyText()">คัดลอกโค้ด</button>
    <h4 class="text-dark "  id="textToCopy">
    <br>
      class Book:<br>
      <br>
def __init__(self, name, price):<br>
    self.name = name<br>
    self.price = price<br>
    <br>
def getDetail(self):<br>
    print('Name: %s' % self.name)<br>
    print('Price: %d USD' % self.price)<br>
b1 = Book('Python language', 59)<br>
b2 = Book('C++ language', 69)<br>
<br>
<br>
b1.getDetail()<br>
b2.getDetail()<br>
